...
<head>
	...
	<spring:message code="login.userIDPH" var="userIDPH" />
	...
	<spring:message code="reset.resetPassword" var="resetPH" />
		...
		<form action="javascript:void(0);" method="get">
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						<p>
							<td><label class="required"><spring:message code="login.userIDLabel" /></label></td>
							<td><input type="text" placeholder='${userIDPH}'>
						</p>
						</td>
					</tr>
